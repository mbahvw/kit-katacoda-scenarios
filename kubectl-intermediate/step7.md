...
Let's  explore how to switch between namespaces by switching to the `frontend` namespace using the below command. Type or click on the command:
...
`Note: you can also replace --namespace flag with the -n flag, which is the short version for it`